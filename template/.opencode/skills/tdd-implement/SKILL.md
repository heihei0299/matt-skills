...
本技能是**长程任务**（Long-Horizon Skill）：多阶段串行执行，自带**回合连续性**（Turn Continuity）与**任务分解**（Chunking）规则（见 [stages.md](stages.md) 阶段③ 3e/3f）。术语定义见 `.opencode/CONTEXT.md`，技能设计规则见 `.opencode/docs/agents/skill-design.md`。
...
- Issue tracker 约定：[issue-tracker.md](../../../.opencode/docs/agents/issue-tracker.md)
